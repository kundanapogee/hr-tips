...
if (isset($_POST['submitFormBtn'])) {
	...
	// echo $_POST['entry_latitude'];
	// echo "<br>";
	// echo $_POST['entry_longitude'];

	// die();

	if((empty($_POST['entry_latitude'])) || (empty($_POST['entry_longitude']))) {
	...
	$entry_time = $date = date('h:i:s A');

	// if ($entry_time>='09:30:00 AM') {
	// 	$_SESSION['msg'] = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
	//                                                 <i class="fas fa-sad-tear me-1"></i>
	//                                                  Please contact to HR for attendance late.
	//                                                 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
	//                                             </div>';
	// 	header("location:../attendanceList.php");
	// 	die();
