...
<head>        
    ...
    <link rel="shortcut icon" href="../admin/assets/images/product/playLogo.png">
    ...
    <link rel="stylesheet" type="text/css" href="../admin/assets/css/myStyle.css">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">       
                                <div>
                                    <form class="custom-validation" action="../admin/employeeAdd-temp.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="mb-3">
