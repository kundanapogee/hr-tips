...
ob_start();
session_start();
if ((!isset($_SESSION['ADMIN-ID-SESS'])) || (empty($_SESSION['ADMIN-ID-SESS']))) {
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="lunchTakenList.php">
                                    <i class="bx bx-home-circle"></i>
                                    <span key="t-dashboards">Lunch Taken List</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="employeeAttendanceList.php">
                                    <i class="bx bx-home-circle"></i>
                                    <span key="t-dashboards">Attendance</span>
                                </a>
                            </li>
                            <li>
                                <a href="employeeLeaveList.php">
                                    <i class="bx bx-home-circle"></i>
                                    <span key="t-dashboards">Employee Leave</span>
                                </a>
                            </li>  
                            <li>
                                <a href="reimbursementList.php">
                                    <i class="bx bx-home-circle"></i>
                                    <span key="t-dashboards">Reimbursement List</span>
                                </a>
                            </li>

                            <li>
                                <a href="reportDate.php">
                                    <i class="bx bx-home-circle"></i>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-crypto">Reports</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <!-- <li><a href="#">Employee</a></li> -->
                                    <!-- <li><a href="#">Attendance Report</a></li> -->
                                    <li><a href="employeeMonthlyAttendanceReport.php">Attendance</a></li>
                                </ul>
                            </li>
